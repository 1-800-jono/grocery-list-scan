...
const fishes = {
  ...
  fish3: {
    name: "Sea Scallops",
    image: require('./images/scallops.jpg'),
  ...
  fish7: {
    name: "Oysters",
    image: require('./images/oysters.jpg'),
  ...
  fish8: {
    name: "Mussels",
    image: require('./images/mussels.jpg'),
  ...
  fish9: {
    name: "Jumbo Prawns",
    image: require('./images/prawns.jpg'),
